...
Files come very dirty. They need to be cleaned as pure text and using raw vectors. This is implemented in the preclean target.

However, further cleaning is necesary
...
list(
  ...
  #            format = 'file'),
  # tar_target(ngram_model,
  #            load_arpa_as_data_table(
  #              tar_read(kenlm_arpa_file)
  #            ))
  )
